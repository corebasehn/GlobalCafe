...
const Cards: FC<ComponentProps> = () => {
  ...
  return (
    <Fragment>
      <Pageheader title="CARDS" heading="Elements" active="CARDS" />
      <Row>
        <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <img src={imagesData('media22')} className="card-img-top" alt="..." />
            <Card.Body>
        ...
        <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <img src={imagesData('media23')} className="card-img-top" alt="..." />
            <Card.Body>
        ...
        <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <img src={imagesData('media24')} className="card-img-top" alt="..." />
            <Card.Body>
              <h6 className="card-title fw-semibold">Card title</h6>
              <p className="card-text">Some quick example text to build on the card title and
                make up the bulk of the card's content.</p>
        ...
        <Col xxl={6} xl={6} lg={12}>
          ...
          <Row className="row-cols-12">
            <div className="col">
              <Card className="custom-card">
                <Card.Body>
                  <img src={imagesData('media25')} className="card-img mb-3" alt="..." />
            ...
            <div className="col">
              <Card className="custom-card">
                <Card.Body>
                  <img src={imagesData('media26')} className="card-img mb-3" alt="..." />
            ...
            <div className="col">
              <Card className="custom-card">
                <Card.Body>
                  <img src={imagesData('media27')} className="card-img mb-3" alt="..." />
            ...
            <Col xl={4}>
              <Card className="text-end custom-card">
                <Card.Body>
                  <div className="mb-2">
                    <span className="avatar avatar-md">
                      <img src={imagesData('face11')} alt="img" />
                    </span>
                  </div>
      ...
      <Row>
            ...
            <div className="card-header">
              <div className="d-flex align-items-center w-100">
                ...
                <Dropdown className='ms-auto'>
                  <Dropdown.Toggle as='a' variant="" className="no-caret btn btn-icon btn-sm btn-light" id="dropdown-basic"><i className="fe fe-more-vertical"></i></Dropdown.Toggle>
                  <Dropdown.Menu>
        ...
        <Col xl={2}>
          <Card className="custom-card">
            <Card.Body>
              <img src={imagesData('media4')} className="card-img mb-3" alt="..." />
        ...
        <Col xl={2}>
          <Card className="custom-card">
            <Card.Body>
              <img src={imagesData('media9')} className="card-img mb-3" alt="..." />
        ...
        <Col xl={2}>
          <Card className="custom-card">
            <Card.Body>
              <img src={imagesData('media15')} className="card-img mb-3" alt="..." />
        ...
        <Col xl={4}>
          ...
          <Modal show={Fullscreen} fullscreen onHide={() => setFullscreen(false)}>
            <Modal.Header closeButton>
              <Modal.Title as='h5'>Card With Fullscreen Button</Modal.Title>
            </Modal.Header>
            <Modal.Body>
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <img src={imagesData('media29')} className="card-img-top" alt="..." />
            <Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={imagesData('media28')} className="card-img-bottom" alt="..." />
          </Card>
        </Col>
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={imagesData('media30')} className="card-img rounded-0" alt="..." />
            <Card.Body>
              <p className="card-text mb-0"><small>Last updated 3 mins
                ago</small></p>
            </Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={imagesData('media31')} className="card-img rounded-0" alt="..." />
            <div className="card-footer">
              <p className="card-text mb-0"><small>Last updated 3 mins
                ago</small></p>
            </div>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <img src={imagesData('media32')} className="card-img-top" alt="..." />
            <div className="card-header border-bottom">
              <div className="card-title">Image caps are widely used in Blog's</div>
            </div>
            <Card.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <img src={imagesData('media33')} className="card-img-bottom" alt="..." />
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={imagesData('media35')} className="card-img" alt="..." />
        ...
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={imagesData('media36')} className="card-img" alt="..." />
        ...
        <Col xl={4}>
          <Card className="custom-card overlay-card">
            <img src={imagesData('media34')} className="card-img" alt="..." />
            <div className="card-img-overlay d-flex flex-column p-0">
              <div className="card-header">
                <div className="card-title text-fixed-white">
                  Image Overlays Are Awesome!
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              <Col md={4}>
                <img src={imagesData('media37')} className="img-fluid rounded-start h-100 w-100" alt="..." />
              </Col>
              <Col md={8}>
                <div className="card-header">
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              ...
              <Col md={4}>
                <img src={imagesData('media38')} className="img-fluid rounded-end h-100 w-100" alt="..." />
              </Col>
            </Row>
          </Card>
        </Col>
        <Col xl={4}>
          <Card className="custom-card">
            <Row className="g-0">
              ...
              <Col md={4}>
                <img src={imagesData('media39')} className="img-fluid rounded-end h-100 w-100" alt="..." />
              </Col>
            </Row>
          </Card>
        </Col>
          ...
          <Card className="custom-card card-bg-dark">
            <Card.Body>
              <div className="d-flex align-items-center w-100">
                <div className="me-2">
                  <span className="avatar avatar-rounded">
                    <img src={imagesData('face16')} alt="img" />
                  </span>
                </div>
                <div className="">
      ...
      <Row>
        <Col xl={12}>
          <div className="card-group mb-4">
            <Card className="custom-card">
              <img src={imagesData('media40')} className="card-img-top" alt="..." />
              <Card.Body>
            ...
            <Card className="custom-card">
              <img src={imagesData('media41')} className="card-img-top" alt="..." />
              <Card.Body>
            ...
            <Card className="custom-card">
              <img src={imagesData('media42')} className="card-img-top" alt="..." />
              <Card.Body>
      ...
      <Row>
            ...
            <Col xxl={7} xl={12}>
              <Card className="custom-card">
                ...
                <Row className="g-0">
                  ...
                  <Col md={4}>
                    <img src={imagesData('media39')} className="img-fluid rounded-end h-100" alt="..." />
                  </Col>
                </Row>
              </Card>
            </Col>
        ...
        <Col xxl={3} xl={6} >
          <Card className="custom-card">
            <Link to="#!" className="card-anchor"></Link>
            <img src={imagesData('media47')} className="card-img-top" alt="..." />
            <Card.Body>
      ...
      <Row>
        <Col xl={12}>
          <Row className="row-cols-1 row-cols-md-4 g-4">
            <div className="col">
              <Card className="custom-card">
                <img src={imagesData('media44')} className="card-img-top" alt="..." />
                <Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={imagesData('media43')} className="card-img-top" alt="..." />
                <Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={imagesData('media45')} className="card-img-top" alt="..." />
                <Card.Body>
                  <h6 className="card-title fw-semibold">Most tropical areas are suitable</h6>
                  <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                </Card.Body>
            ...
            <div className="col">
              <Card className="custom-card">
                <img src={imagesData('media46')} className="card-img-top" alt="..." />
                <Card.Body>
