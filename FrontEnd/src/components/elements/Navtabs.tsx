...
const Navtabs: FC<ComponentProps> = () => {
    return (
        <Fragment>
            <Pageheader title="NAVS & TABS" heading="Elements" active="NAVS & TABS" />
                            ...
                            <div className="example">
                                <Tab.Container defaultActiveKey="first">
                                    <Nav variant="pills" className="nav-tabs justify-content-center mb-5 tab-style-3" id="myTab2" role="tablist" defaultActiveKey="first">
                                        ...
                                        <Nav.Item> <Nav.Link eventKey="second" className="about py-1" id="profile-tab" type="button" >About</Nav.Link> </Nav.Item>
                                        <Nav.Item> <Nav.Link eventKey="third" className="services py-1" id="contact-tab" type="button" >Services</Nav.Link> </Nav.Item>
                                    </Nav>
                                ...
                                <Tab.Container defaultActiveKey="first">
                                    <nav>
                                        <Nav variant="pills" className="nav-tabs nav-justified tab-style-4 d-flex" id="myTab2" role="tablist" defaultActiveKey="first">
                                            ...
                                            <Nav.Link eventKey="third" id="nav-contact-tab" type="button">Contact Us</Nav.Link>
                                        </Nav>
                                    </nav>
                                                ...
                                                <table className="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <img src={imagesData('ecommerce3')} alt="img" />
                                                                </span>
                                                            </th>
                                                            <td>Stop Watch</td>
                                                            <td>Clocks</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <img src={imagesData('ecommerce4')} alt="img" />
                                                                </span>
                                                            </th>
                                                            <td>Camera</td>
                                                            <td>Gadgets</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span className="avatar avatar-sm">
                                                                    <img src={imagesData('ecommerce6')} alt="img" />
                                                                </span>
                                                            </th>
                                                            <td>Shoes</td>
                                                            <td>Footwear</td>
