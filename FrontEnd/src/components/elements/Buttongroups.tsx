...
import { Radio, Radiovertical } from '../../common/commondata';
import Pageheader from '../../layout/layoutcomponent/pageheader';

interface ComponentProps { }

const Buttongroups: FC<ComponentProps> = () => {
...
`}
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className={`checkbox-button-group ${isHidden[4] ? 'd-none' : ''}`}>
                            <div className="example">
...
`}
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className={`radio-button-group ${isHidden[5] ? 'd-none' : ''}`}>
                            <div className="example">
...
`}
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className={`d-flex flex-wrap ${isHidden[6] ? 'd-none' : ''}`}>
                            <div className="example">
                        ...
                        <Card.Body className={`${isHidden[10] ? 'd-none' : ''}`}>
                            <div className="example">
                                <ButtonGroup role="group" aria-label="Basic example">
                                    ...
                                    <Button variant='twitter' className="btn-wave"><i className="ri-twitter-x-line"></i></Button>
