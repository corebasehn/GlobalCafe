...
const Additionalcontent: FC<ComponentProps> = () => {
    return (
        <Fragment>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="d-md-flex">
                                    <div className="overflow-auto p-3 mb-3 mb-md-0 me-md-3 bg-light" style={{ maxWidth: '260px', maxHeight: '100px', overflowY: 'auto' }}>
                                        This is an example of using <code>.overflow-auto</code> on an element with set width and height dimensions. By design, this content will vertically scroll.
                                    </div>
                                    <div className="overflow-hidden p-3 mb-3 mb-md-0 me-md-3 bg-light" style={{ maxWidth: '260px', maxHeight: '100px', overflow: 'hidden' }}>
                                        This is an example of using <code>.overflow-hidden</code> on an element with set width and height dimensions.
                                    </div>
                                    <div className="overflow-visible p-3 mb-3 mb-md-0 me-md-3 bg-light" style={{ maxWidth: '260px', maxHeight: '100px', overflow: 'visible' }}>
                                        This is an example of using <code>.overflow-visible</code> on an element with set width and height dimensions.
                                    </div>
                                    <div className="overflow-scroll p-3 bg-light" style={{ maxWidth: '260px', maxHeight: '100px', overflow: 'scroll' }}>
            ...
            <Row>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <div style={{ height: '100px', backgroundColor: 'rgba(255,0,0,0.1)' }} className="d-flex">
                                <div className="h-25 text-center d-inline-block" style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Height 25%
                                </div>
                                <div className="h-50 text-center d-inline-block" style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Height 50%
                                </div>
                                <div className="h-75 text-center d-inline-block" style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Height 75%
                                </div>
                                <div className="h-100 text-center d-inline-block" style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Height 100%
                                </div>
                                <div className="h-auto text-center d-inline-block" style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Height auto
                                </div>
                            </div>
                        </Card.Body>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <img className="bd-placeholder-img mw-100 card-img" src={imagesData('media7')} alt="..." />
                            <div style={{ height: '100px', backgroundColor: 'rgba(255,0,0,.1)' }} className="mt-3">
                                <div className="mh-100 text-center" style={{ width: '100px', height: '200px', backgroundColor: 'rgba(0,0,255,.1)' }}>
                                    Max-height 100%
                                </div>
                            </div>
                        </Card.Body>
