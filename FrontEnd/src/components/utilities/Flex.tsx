                        ...
                        <Card.Body>
                            <div className="d-sm-flex mb-3">
                                <div className="flex-shrink-0 mb-3 mb-sm-0">
                                    <img className="bd-placeholder-img card-img w-10 h-10" src={imagesData('face6')} alt="img" />
                                </div>
                            ...
                            <div className="d-sm-flex align-items-center">
                                <div className="flex-shrink-0 mb-3 mb-sm-0">
                                    <img className="bd-placeholder-img card-img avatar-xl" src={imagesData('face15')} alt="img" />
                                </div>
                                <div className="flex-grow-1 ms-3">
