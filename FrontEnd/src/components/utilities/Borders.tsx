...
const Borders: FC<ComponentProps> = () => {
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className={`${isHidden[6] ? 'd-none' : ''}`}>
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded-top" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded-end" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded-bottom" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded-start" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img rounded-circle" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img  rounded-pill" alt="..." />
                        </Card.Body>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className={`${isHidden[7] ? 'd-none' : ''}`}>
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-0" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-1" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-2" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-3" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-4" alt="..." />
                            <img src={imagesData('media58')} className="bd-placeholder-img bd-placeholder-img rounded-5" alt="..." />
                        </Card.Body>
