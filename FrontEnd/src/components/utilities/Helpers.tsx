...
const Helpers: FC<ComponentProps> = () => {
    return (
        <Fragment>
            ...
            <Row>
                ...
                <Col xxl={3} xl={3} lg={6} md={6} sm={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <img className="bd-placeholder-img card-img-top card-img" src={imagesData('media4')} alt="..." />
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-evenly flex-wrap">
                                ...
                                <Link to="#" className="fw-medium fs-15 p-1">Light</Link>
