...
import { BasicSelect, MaxData, MultipleSelect, TemptingData } from '../../common/selectdata';
import Pageheader from '../../layout/layoutcomponent/pageheader';

interface ComponentProps { }

const Select2: FC<ComponentProps> = () => {
            ...
            <Row className="row-sm">
                ...
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Select options={MultipleSelect} classNamePrefix="Select2" isMulti defaultValue={MultipleSelect[0]} />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4}>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="vstack gap-3">
                            {isEnabled ? (
                                <>
                                    <Select options={BasicSelect} classNamePrefix="Select2" placeholder="Selection 1" menuPlacement='top'/>
                                    <Select options={BasicSelect} classNamePrefix="Select2" placeholder="Selection 1" menuPlacement='top'/>
                                </>
                            ) : (
                                <>
                                    <Select options={BasicSelect} classNamePrefix="Select2" placeholder="Selection 1" isDisabled menuPlacement='top'/>
                                    <Select options={BasicSelect} classNamePrefix="Select2" placeholder="Selection 1" isDisabled menuPlacement='top'/>
                                </>
                            )}
