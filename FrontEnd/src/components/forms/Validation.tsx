...
const Validation: FC<ComponentProps> = () => {
...
<Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
            <div className="card-title">Browser default Validation</div>
              <div className="prism-toggle">
...
<Button type="submit">Submit form</Button>
      ...
      <Row className="row-sm">
        ...
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
            <div className="card-title"> Server side Validation</div>
              <div className="prism-toggle">
...
<Formik validationSchema={schema1} onSubmit={console.log} initialValues={{ firstName: 'Mark', lastName: 'Otto', username: '', city: '', state: '', zip: '', file: null, terms: false, }}>
        ...
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
            <div className="card-title"> Supported elements </div>
              <div className="prism-toggle">
