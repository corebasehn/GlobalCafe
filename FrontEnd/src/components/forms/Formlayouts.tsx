...
import { Countrypreference, Preference, Statepreference } from '../../common/selectdata';
import Pageheader from '../../layout/layoutcomponent/pageheader';

interface ComponentProps { }

const Formlayouts: FC<ComponentProps> = () => {

  const [maritalStatus, setMaritalStatus] = useState<'married' | 'single'>('married');

const handleMaritalStatusChange = (status: 'married' | 'single') => {
