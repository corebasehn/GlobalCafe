      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <div className={`${isHidden[1] ? '' : 'd-none'} card-footer`}>
              {/* <!-- Prism Code --> */}
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <div className={`card-footer ${isHidden[2] ? '' : 'd-none'}`}>
              <pre><code className='language-javascript'>
                {`
                <Row className="gy-3">
                <Col xl={12}>
      ...
      <Row className="row-sm">
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <div className={`card-footer ${isHidden[3] ? '' : 'd-none'}`}>
              <pre><code className='language-javascript'>
                {`
                 <Form.Control className="form-control-sm mb-3" type="text"
                 placeholder=".form-control-sm" aria-label=".form-control-sm example" />
      ...
      <Row className="row-sm">
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <div className={`card-footer ${isHidden[4] ? '' : 'd-none'}`}>
              <pre><code className='language-javascript'>
                {`
               <form>
               <div className="mb-3">
          ...
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                ...
                <div className={`${isHidden[5] ? '' : 'd-none'} card-footer`}>
                  <pre><code className='language-javascript'>
                    {`
               <Form.Label htmlFor="inputPassword5">Password</Form.Label>
               <Form.Control type="password" id="inputPassword5"
            ...
            <Col xl={12}>
              <Card className="custom-card">
                ...
                <div className={`card-footer ${isHidden[6] ? '' : 'd-none'}`}>
                  <pre><code className='language-javascript'>
                    {`
                <Row className="g-3 align-items-center">
                <div className="col-auto">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <div className={`card-footer ${isHidden[7] ? '' : 'd-none'}`}>
              <pre><code className='language-javascript'>
                {`
                <form>
                <fieldset disabled>
