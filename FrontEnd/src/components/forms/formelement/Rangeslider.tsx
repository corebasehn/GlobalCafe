...
import { LabeledTwoThumbs, MinMaxSlider, ProgrameticSlider, StepSlider, UpdatingMarks } from '../../../common/SliderFunctionality';
...
const Rangeslider: FC<ComponentProps> = ({ local_varaiable }: any) => {
