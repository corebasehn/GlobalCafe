...
const Checkradios: FC<ComponentProps> = () => {
  ...
  const handleToggleClick = (toggleName: string) => {
  ...
  const handleToggleChange = (toggleName: keyof ToggleStates) => {
