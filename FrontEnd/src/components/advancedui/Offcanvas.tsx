...
import { BackDrop, BodyScroll, BodyScrollandBackDrop, LiveDemo, Placement } from '../../common/Offcanvasfunctionality';
import Pageheader from '../../layout/layoutcomponent/pageheader';

interface ComponentProps { }

const Offcanvas: FC<ComponentProps> = () => {
    //Show code
...
export const Placement = () => {
    ...
    const handleShow = (placement: any) => {
        setShow(true);
