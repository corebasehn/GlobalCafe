                        ...
                        <Card.Body>
                            <ReactNavbar expand="lg" bg="light" data-bs-theme="light" className="bg-body-tertiary">
                                <div className="container-fluid">
                                    <ReactNavbar.Brand><img src={imagesData('togglelogo')} alt="" className="d-inline-block" /></ReactNavbar.Brand>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ReactNavbar expand="lg" bg="light" data-bs-theme="light" className="bg-body-tertiary mb-3">
                                <div className="container-fluid">
                                    <ReactNavbar.Brand><img src={imagesData('togglelogo')} alt="" /></ReactNavbar.Brand>
                                </div>
                            </ReactNavbar>
                            <ReactNavbar expand="lg" bg="light" data-bs-theme="light" className="bg-body-tertiary">
                                <div className="container-fluid">
                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ReactNavbar expand="lg" bg="light" data-bs-theme="light" className="bg-body-tertiary">
                                <div className="container-fluid">
                                    <ReactNavbar.Brand className="text-default d-inline-flex align-items-center gap-2"><img src={imagesData('togglelogo')} alt="" className="d-inline-block align-text-top" />React BootStrap</ReactNavbar.Brand>
                                </div>
                            </ReactNavbar>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ReactNavbar expand="lg" data-bs-theme="primary" className="navbar-primary mb-3">
                                <div className="container-fluid">
                                    <ReactNavbar.Brand> <img src={imagesData('toggledark')} alt="" /></ReactNavbar.Brand>
                                    <ReactNavbar.Toggle aria-controls="basic-navbar-nav" />
                                    <ReactNavbar.Collapse id="basic-navbar-nav">
                                        <Nav className="me-auto mb-2 mb-lg-0">
                                            <Nav.Link className='me-1' href="#home" active>Home</Nav.Link>
            ...
            <Row className="row-sm">
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ReactNavbar collapseOnSelect expand="lg" className="bg-body-tertiary bg-light mb-3">
                                <Container fluid>
                            ...
                            <ReactNavbar collapseOnSelect expand="lg" className="bg-body-tertiary bg-light mb-3">
                                <Container fluid>
                                    <ReactNavbar.Brand href="#home">Navbar</ReactNavbar.Brand>
                                    <ReactNavbar.Toggle aria-controls="responsive-navbar-nav" />
                                    <ReactNavbar.Collapse id="responsive-navbar-nav">
                                        <Nav className="me-auto">
                                            <Nav.Link active>Home</Nav.Link>
                            ...
                            <ReactNavbar collapseOnSelect expand="lg" className="bg-body-tertiary bg-light mb-2">
                                <Container fluid>
                                    <ReactNavbar.Toggle aria-controls="responsive-navbar-nav" />
                                    <ReactNavbar.Brand href="#home">Navbar</ReactNavbar.Brand>
                                    <ReactNavbar.Collapse id="responsive-navbar-nav">
                                    ...
                                    >
                                        ...
                                        <Offcanvas.Body>
                                            <Nav as='ul' className="justify-content-end flex-grow-1 pe-3">
                                                <Nav.Item as='li'><Nav.Link aria-current="page" href="#link">Home</Nav.Link> </Nav.Item>
                                                <Nav.Item as='li'> <Nav.Link href="#link1">Link</Nav.Link> </Nav.Item>
                                                <NavDropdown
                                                    title="Dropdown"
