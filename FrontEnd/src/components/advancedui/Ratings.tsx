...
import { Customizable, HoverRating } from '../../common/Ratingfunctionality';
import StarIcon from '@mui/icons-material/Star';

interface ComponentProps { }

const Ratings: FC<ComponentProps> = () => {
      ...
      <Row className="row-sm">
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <div className="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div className="d-flex flex-wrap align-items-center">
                  <Rating name="disabled" defaultValue={value0} emptyIcon={<StarIcon style={{ opacity: 0.55 }} fontSize="inherit" />} disabled />
                </div>
              </div>
            </Card.Body>
          </Card>
        ...
        <Col xxl={4} xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <div className="d-flex flex-wrap align-items-center justify-content-between">
                <p className="fs-14 mb-0 fw-semibold">Readonly rating :</p>
                <div className="d-flex flex-wrap align-items-center">
                  <Rating defaultValue={3} emptyIcon={<StarIcon style={{ opacity: 0.55 }} fontSize="inherit" />} readOnly />
                </div>
              </div>
            </Card.Body>
          </Card>
