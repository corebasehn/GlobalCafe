...
const Aboutus: FC<ComponentProps> = () => {
  return (
    <Fragment>
      ...
      <div className="container">
        <Row className="about-main mb-5">
          <Col lg={8} md={8} sm={12} className="text-center">
            <h1 className="mb-3 fw-semibold fs-46">
              Hello! This is <span className="text-primary fs-56 text-transparent">Nowa.</span>
            </h1>
        ...
        <Row className="py-5 about-motto pt-0">
          <Col lg={8} md={8} sm={12} >
            <div className="text-justify">
              <div className="text-dark fs-26 fw-semibold">
                Our Motto
              </div>
              ...
              <Card className=" p-3">
                <Card.Body>
                  ...
                  <p className="text-center mb-0">
                    <i className="fe fe-facebook text-primary me-3 fs-16"></i>
                    <i className="fe fe-instagram text-secondary me-3  fs-16"></i>
                    <i className="fe fe-globe text-info me-3  fs-16"></i>
                  </p>
                </Card.Body>
              </Card>
            </Col>
