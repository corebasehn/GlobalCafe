...
export const DATATABLE5 = [
  {
    ...
    NAME: "Adam Cotter",
    ROLE: "Architect", 
    LAST: <span className="badge bg-light text-muted fs-13">20 days ago</span>,
    COUNTRY: "France",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "	09 Dec 2017",
  ...
  },
  {
    ...
    LAST: <span className="badge bg-light text-muted fs-13">36 mins ago</span>,
    COUNTRY: "Columbia",
    BADGE:<span className="badge fw-semibold bg-danger-transparent text-danger fs-11"> Not Verified</span>,
    DATE: "	26 Jan 2018",
  },
  {
    SNO: <Form.Check className='align-middle ' />,
    ...
    ROLE: "Accountant",
    LAST:<span className="badge bg-light text-muted fs-13">11 hrs ago</span>,
    COUNTRY: "Spain",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "	27 Jan 2018",
  ...
  },
  {
    ...
    LAST:<span className="badge bg-light text-muted fs-13">21 hrs ago</span>,
    COUNTRY: "Bermuda",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "	20 Jan 2018",
  },
  {
    ...
    NAME: "Rutter Pude",
    ROLE: "Integration Specialist",
    LAST: <span className="badge bg-light text-muted fs-13">14 mins ago</span>,
    COUNTRY: "Portugal",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "13 Jan 2018",
  ...
  },
  {
    ...
    LAST:<span className="badge bg-light text-muted fs-13">19 hrs ago</span>,
    COUNTRY: "India",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "25 Jan 2018",
  ...
  },
  {
    ...
    NAME: "Thedric Romans",
    ROLE: "Office Manager",
    LAST: <span className="badge bg-light text-muted fs-13">15 days ago</span>,
    COUNTRY: "Romania",
    BADGE:<span className="badge fw-semibold bg-danger-transparent text-danger fs-11">Not Verified</span>,
    DATE: "	12 Jan 2018",
  },
  {
    ...
    NAME: "Haily Carthew",
    ROLE: "Support Lead",
    LAST: <span className="badge bg-light text-muted fs-13">1 month ago</span>,
    COUNTRY: "Japan",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "	27 Jan 2018",
  ...
  },
  {
    ...
    LAST:<span className="badge bg-light text-muted fs-13">2 days ago</span>,
    COUNTRY: "Mexico",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "	12 Dec 2017",
  ...
  },
  {
    ...
    LAST: <span className="badge bg-light text-muted fs-13">12 mins ago</span>,
    COUNTRY: "Italy",
    BADGE:<span className="badge fw-semibold bg-success-transparent text-success fs-11">Verified</span>,
    DATE: "10 Dec 2017",
    ...
    <Row>
      ...
      <Card>
          <Card.Header className="border-bottom-0 p-4 d-flex justify-content-between">
            <Card.Title className="fs-13">1 - 30 of 546 users</Card.Title>
            <div className="d-flex">
                <select
                  className="mb-6 table-border me-1"
                  value={pageSize}
